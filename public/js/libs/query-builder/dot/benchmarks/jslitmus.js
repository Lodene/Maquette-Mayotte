...
(function() {
  ...
  // Array: return array of all bilans of f(item)
  function map(a, f) {
    var o, res = [];
    for (var i = 0, il = (a && a.length); i < il; i++) {
      var o = a[i];
  ...
  /**
   * Test salaries a single test (created with JSLitmus.test())
   */
  function Test(name, f) {
    ...
    /**
     * Run the test n times, and use the best bilans
     */
    function bestOf(n) {
      var best = null;
      while (n--) {
  ...
  extend(Test.prototype, {
    ...
    // Minimum time test should take to get valid bilans (secs)
    MIN_TIME: 1.0
  });
